    ...
    <div class="container p-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 mb-4 mb-md-0">
                <h5 class="alike">About</h5>

                <ul>
                    <li>
                        <a href="<?= base_url('blog/Blog/Auriga') ?>" class="text-white">About Auriga</a>
                    </li>
                    <li>
                        <a href="<?= base_url('blog/Blog/Auriga') ?>" class="text-white">Law
                            Environment</a>
                    </li>
                    <li>
            ...
            <div class="col-lg-6 col-sm-6 mb-md-0">
                ...
                <ul>
                    <li>
                        <a href="<?= base_url('blog/Blog/Auriga') ?>" class="text-white">Contact Calm Expert</a>
                    </li>
                    <li>
                        <a href="<?= base_url('blog/Blog/Auriga') ?>" class="text-white">Forum Discussion</a>
                    </li>
                </ul>
            </div>
            <!--Grid column-->
