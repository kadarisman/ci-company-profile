<header class="text-white bg6">
    <div class="container text-left">
        <h1 class="miniver">Welcome .... <?php if ($this->session->userdata('email')) {
        ...
        <a class="btn btn-success btn-sm btn1" href="<?= base_url('blog/Blog/Auriga') ?>" role="button">Learn More</a>
        <a class="btn btn-success btn-sm btn2" href="<?= base_url('auth/Auth/Registrasi') ?>" role="button">Join Us</a>
    </div>
</header>